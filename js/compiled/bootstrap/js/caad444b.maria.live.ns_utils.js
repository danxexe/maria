...
return cljs.core.second(G__50085);
} else {
return G__50085;
}
});
...
var _STAR_compiler_STAR__orig_val__50096 = cljs.env._STAR_compiler_STAR_;
var _STAR_compiler_STAR__temp_val__50097 = c_state;
cljs.env._STAR_compiler_STAR_ = _STAR_compiler_STAR__temp_val__50097;
...
}finally {cljs.env._STAR_compiler_STAR_ = _STAR_compiler_STAR__orig_val__50096;
}});
/**
...
var vec__50104 = maria.live.ns_utils.resolve_sym(c_state,c_env,sym);
var namespace = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50104,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50104,(1),null);
...
maria.live.ns_utils.ns_publics_STAR_.cljs$core$IFn$_invoke$arity$3 = (function (the_ns,only_doc_QMARK_,p__50109){
...
var include = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50110__$1,new cljs.core.Keyword(null,"include","include",153360230));
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (map__50110,map__50110__$1,include){
return (function (names,p__50112){
var map__50113 = p__50112;
...
var the_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50113__$1,new cljs.core.Keyword(null,"name","name",1843675177));
var doc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50113__$1,new cljs.core.Keyword(null,"doc","doc",1913296891));
var anonymous = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50113__$1,new cljs.core.Keyword(null,"anonymous","anonymous",447897231));
var private$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50113__$1,new cljs.core.Keyword(null,"private","private",-558947994));
var G__50115 = names;
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__50115,cljs.core.name(the_name),the_name);
} else {
return G__50115;
}
});})(map__50110,map__50110__$1,include))
...
maria.live.ns_utils.full_name = (function maria$live$ns_utils$full_name(kind,p__50116){
var vec__50117 = p__50116;
var the_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50117,(0),null);
var the_target = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50117,(1),null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50120__$1)].join('')));
...
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([names,maria.live.ns_utils.update_kvs(cljs.core.get.cljs$core$IFn$_invoke$arity$2(the_ns,k),cljs.core.comp.cljs$core$IFn$_invoke$arity$2(cljs.core.str,cljs.core.first),(function (p1__50121_SHARP_){
return maria.live.ns_utils.full_name(k,p1__50121_SHARP_);
}))], 0));
...
var G__50122 = (maria.live.ns_utils.special_doc_map.cljs$core$IFn$_invoke$arity$1 ? maria.live.ns_utils.special_doc_map.cljs$core$IFn$_invoke$arity$1(name_symbol) : maria.live.ns_utils.special_doc_map.call(null,name_symbol));
if((G__50122 == null)){
return null;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$variadic(G__50122,new cljs.core.Keyword(null,"name","name",1843675177),cljs.core.symbol.cljs$core$IFn$_invoke$arity$2("clojure.core",cljs.core.name(name_symbol)),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"special-form","special-form",-1326536374),true], 0));
}
});
...
var temp__5720__auto__ = (function (){var G__50139 = node;
if((G__50139 == null)){
return null;
} else {
return G__50139.value;
}
})();
if(cljs.core.truth_(temp__5720__auto__)){
...
maria.live.ns_utils.ns_completions.cljs$core$IFn$_invoke$arity$2 = (function (ns_name,p__50158){
var vec__50159 = p__50158;
var the_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50159,(0),null);
var the_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50159,(1),null);
var resolved_ns = (function (){var G__50162 = (function (){var or__4131__auto__ = the_ns;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
return the_name;
...
var G__50162__$1 = (((G__50162 == null))?null:cljs.analyzer.resolve_ns_alias.cljs$core$IFn$_invoke$arity$2(maria.live.ns_utils.ana_env(),G__50162));
if((G__50162__$1 == null)){
return null;
} else {
return maria.live.ns_utils.get_ns.cljs$core$IFn$_invoke$arity$1(G__50162__$1);
}
})();
...
return cljs.core.sort.cljs$core$IFn$_invoke$arity$1((function (){var iter__4523__auto__ = ((function (resolved_ns,printable_ns,the_name__$1,vec__50159,the_ns,the_name){
return (function maria$live$ns_utils$iter__50163(s__50164){
return (new cljs.core.LazySeq(null,((function (resolved_ns,printable_ns,the_name__$1,vec__50159,the_ns,the_name){
return (function (){
var s__50164__$1 = s__50164;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__50164__$1);
if(temp__5720__auto__){
var s__50164__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__50164__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__50164__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__50166 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__50165 = (0);
while(true){
if((i__50165 < size__4522__auto__)){
var vec__50167 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__50165);
var alias = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50167,(0),null);
var full_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50167,(1),null);
...
var completion = (function (){var G__50170 = alias;
if(cljs.core.truth_(printable_ns)){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(printable_ns),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50170)].join('');
} else {
return G__50170;
}
})();
cljs.core.chunk_append(b__50166,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [alias,completion,full_name], null));

var G__50308 = (i__50165 + (1));
i__50165 = G__50308;
continue;
} else {
var G__50309 = (i__50165 + (1));
i__50165 = G__50309;
continue;
}
} else {
...
return cljs.core.chunk_cons(cljs.core.chunk(b__50166),maria$live$ns_utils$iter__50163(cljs.core.chunk_rest(s__50164__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__50166),null);
}
} else {
var vec__50171 = cljs.core.first(s__50164__$2);
var alias = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50171,(0),null);
var full_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50171,(1),null);
if(((clojure.string.starts_with_QMARK_(alias,the_name__$1)) && (cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(alias,the_name__$1)))){
var completion = (function (){var G__50174 = alias;
if(cljs.core.truth_(printable_ns)){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(printable_ns),"/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__50174)].join('');
} else {
return G__50174;
}
})();
return cljs.core.cons(new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [alias,completion,full_name], null),maria$live$ns_utils$iter__50163(cljs.core.rest(s__50164__$2)));
} else {
var G__50310 = cljs.core.rest(s__50164__$2);
s__50164__$1 = G__50310;
continue;
}
}
} else {
...
});})(resolved_ns,printable_ns,the_name__$1,vec__50159,the_ns,the_name))
,null,null));
});})(resolved_ns,printable_ns,the_name__$1,vec__50159,the_ns,the_name))
;
...
})())?(function (){var G__50175 = resolved_ns;
if((G__50175 == null)){
return null;
} else {
return maria.live.ns_utils.ns_publics_STAR_.cljs$core$IFn$_invoke$arity$2(G__50175,false);
}
