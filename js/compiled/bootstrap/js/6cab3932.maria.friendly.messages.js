...
maria.friendly.messages.match_in_tokens.cljs$core$IFn$_invoke$arity$3 = (function (trie,p__50187,context){
var vec__50189 = p__50187;
...
var token = first__50191;
var remaining_tokens = seq__50190__$1;
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.empty_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__50192_SHARP_){
return clojure.string.replace(p1__50192_SHARP_,"_","-");
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (trie,p__50202){
var vec__50204 = p__50202;
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50204,(0),null);
var output = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50204,(1),null);
...
if(cljs.core.truth_((function (){var G__50212 = match;
if((G__50212 == null)){
return null;
} else {
return cljs.core.contains_QMARK_(G__50212,new cljs.core.Keyword(null,"message","message",-406056002));
}
})())){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (match){
return (function (message__$1,p__50217){
var vec__50218 = p__50217;
var i = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50218,(0),null);
var replacement = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50218,(1),null);
...
return cljs.core.keep.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (){var G__50225 = cljs.core.ex_message(cljs.core.ex_cause(error));
if((G__50225 == null)){
return null;
} else {
return maria.friendly.messages.prettify_error_message(G__50225);
}
})(),(function (){var G__50226 = cljs.core.ex_message(error);
if((G__50226 == null)){
return null;
} else {
return maria.friendly.messages.prettify_error_message(G__50226);
}
})()], null));
} else {
...
var G__50233 = cljs.core.count(sq);
switch (G__50233) {
case (1):
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (row,p__50249){
var vec__50250 = p__50249;
var diagonal = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50250,(0),null);
var above = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50250,(1),null);
var other_element = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50250,(2),null);
...
var len__4730__auto___50311 = arguments.length;
var i__4731__auto___50312 = (0);
while(true){
if((i__4731__auto___50312 < len__4730__auto___50311)){
args__4736__auto__.push((arguments[i__4731__auto___50312]));

var G__50313 = (i__4731__auto___50312 + (1));
i__4731__auto___50312 = G__50313;
continue;
} else {
}
break;
...
maria.friendly.messages.levenshtein_distance.cljs$core$IFn$_invoke$arity$variadic = (function (a,b,p__50259){
...
var p = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__50260__$1,new cljs.core.Keyword(null,"predicate","predicate",-1742501860),cljs.core._EQ_);
return cljs.core.peek(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (map__50260,map__50260__$1,p){
return (function (prev_row,current_element){
return maria.friendly.messages.compute_next_row(prev_row,current_element,b,p);
});})(map__50260,map__50260__$1,p))
,cljs.core.map.cljs$core$IFn$_invoke$arity$3(((function (map__50260,map__50260__$1,p){
return (function (p1__50255_SHARP_,p2__50254_SHARP_){
return cljs.core.identity(p2__50254_SHARP_);
});})(map__50260,map__50260__$1,p))
...
/** @this {Function} */
maria.friendly.messages.levenshtein_distance.cljs$lang$applyTo = (function (seq50256){
var G__50257 = cljs.core.first(seq50256);
var seq50256__$1 = cljs.core.next(seq50256);
var G__50258 = cljs.core.first(seq50256__$1);
var seq50256__$2 = cljs.core.next(seq50256__$1);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50257,G__50258,seq50256__$2);
});
...
var missing_name = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50271__$1,new cljs.core.Keyword(null,"suffix","suffix",367373057));
var macro_present_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__50271__$1,new cljs.core.Keyword(null,"macro-present?","macro-present?",-1397713205));
...
var seq__50274 = cljs.core.seq(maria.friendly.messages.analyzer_messages);
var chunk__50275 = null;
var count__50276 = (0);
var i__50277 = (0);
while(true){
if((i__50277 < count__50276)){
var vec__50286 = chunk__50275.cljs$core$IIndexed$_nth$arity$2(null,i__50277);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50286,(0),null);
var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50286,(1),null);
...
var G__50315 = seq__50274;
var G__50316 = chunk__50275;
var G__50317 = count__50276;
var G__50318 = (i__50277 + (1));
seq__50274 = G__50315;
chunk__50275 = G__50316;
count__50276 = G__50317;
i__50277 = G__50318;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq(seq__50274);
if(temp__5720__auto__){
var seq__50274__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__50274__$1)){
var c__4550__auto__ = cljs.core.chunk_first(seq__50274__$1);
var G__50319 = cljs.core.chunk_rest(seq__50274__$1);
var G__50320 = c__4550__auto__;
var G__50321 = cljs.core.count(c__4550__auto__);
var G__50322 = (0);
seq__50274 = G__50319;
chunk__50275 = G__50320;
count__50276 = G__50321;
i__50277 = G__50322;
continue;
} else {
var vec__50292 = cljs.core.first(seq__50274__$1);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50292,(0),null);
var f = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__50292,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword("maria.friendly.messages","pass","maria.friendly.messages/pass",52119636),f)){
} else {
cljs.analyzer.error_message.cljs$core$IMultiFn$_add_method$arity$3(null,k,f);
}
...
var G__50323 = cljs.core.next(seq__50274__$1);
var G__50324 = null;
var G__50325 = (0);
var G__50326 = (0);
seq__50274 = G__50323;
chunk__50275 = G__50324;
count__50276 = G__50325;
i__50277 = G__50326;
continue;
}
} else {
...
if(cljs.core.truth_((function (){var G__50297 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(warning);
return (maria.friendly.messages.ignored_warning_types.cljs$core$IFn$_invoke$arity$1 ? maria.friendly.messages.ignored_warning_types.cljs$core$IFn$_invoke$arity$1(G__50297) : maria.friendly.messages.ignored_warning_types.call(null,G__50297));
})())){
return null;
} else {
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),(function (){var G__50298 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(warning);
var G__50299 = new cljs.core.Keyword(null,"extra","extra",1612569067).cljs$core$IFn$_invoke$arity$1(warning);
return (cljs.analyzer.error_message.cljs$core$IFn$_invoke$arity$2 ? cljs.analyzer.error_message.cljs$core$IFn$_invoke$arity$2(G__50298,G__50299) : cljs.analyzer.error_message.call(null,G__50298,G__50299));
