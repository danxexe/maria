...
goog.dom.browserrange.IeRange = function(range, doc) {
  /** @private @type {?Node} */ this.parentNode_ = null;
  /** @private @type {?Node} */ this.startNode_ = null;
  /** @private @type {?Node} */ this.endNode_ = null;
  /** @private @type {number} */ this.startOffset_ = -1;
  /** @private @type {number} */ this.endOffset_ = -1;
  /** @private @type {TextRange} */ this.range_ = range;
  /** @private @type {Document} */ this.doc_ = doc;
};
goog.inherits(goog.dom.browserrange.IeRange, goog.dom.browserrange.AbstractRange);
/** @private @type {goog.log.Logger} */ goog.dom.browserrange.IeRange.logger_ = goog.log.getLogger("goog.dom.browserrange.IeRange");
/**
 @private
 @param {Node} node
 @return {!TextRange}
...
goog.dom.browserrange.IeRange.getBrowserRangeForNodes_ = function(startNode, startOffset, endNode, endOffset) {
  ...
  if (startNode.nodeType == goog.dom.NodeType.ELEMENT) {
    if (startOffset > startNode.childNodes.length) {
      goog.log.error(goog.dom.browserrange.IeRange.logger_, "Cannot have startOffset \x3e startNode child count");
    }
  ...
  if (endNode.nodeType == goog.dom.NodeType.ELEMENT) {
    if (endOffset > endNode.childNodes.length) {
      goog.log.error(goog.dom.browserrange.IeRange.logger_, "Cannot have endOffset \x3e endNode child count");
    }
...
/**
 @param {Node} node
 @return {!goog.dom.browserrange.IeRange}
 */
...
/** @override */ goog.dom.browserrange.IeRange.prototype.getBrowserRange = function() {
  return this.range_;
};
/** @private */ goog.dom.browserrange.IeRange.prototype.clearCachedValues_ = function() {
  this.parentNode_ = this.startNode_ = this.endNode_ = null;
  this.startOffset_ = this.endOffset_ = -1;
};
/** @override */ goog.dom.browserrange.IeRange.prototype.getContainer = function() {
  if (!this.parentNode_) {
...
/** @override */ goog.dom.browserrange.IeRange.prototype.getStartNode = function() {
  if (!this.startNode_) {
...
/** @override */ goog.dom.browserrange.IeRange.prototype.getStartOffset = function() {
...
/** @override */ goog.dom.browserrange.IeRange.prototype.getEndNode = function() {
  if (this.isCollapsed()) {
...
/** @override */ goog.dom.browserrange.IeRange.prototype.getEndOffset = function() {
  if (this.isCollapsed()) {
...
/** @override */ goog.dom.browserrange.IeRange.prototype.compareBrowserRangeEndpoints = function(range, thisEndpoint, otherEndpoint) {
...
/** @override */ goog.dom.browserrange.IeRange.prototype.isCollapsed = function() {
  return this.range_.compareEndPoints("StartToEnd", this.range_) == 0;
};
/** @override */ goog.dom.browserrange.IeRange.prototype.getText = function() {
  return this.range_.text;
};
/** @override */ goog.dom.browserrange.IeRange.prototype.getValidHtml = function() {
  return this.range_.htmlText;
};
/** @override */ goog.dom.browserrange.IeRange.prototype.select = function(opt_reverse) {
  this.range_.select();
};
/** @override */ goog.dom.browserrange.IeRange.prototype.removeContents = function() {
...
/** @override */ goog.dom.browserrange.IeRange.prototype.surroundContents = function(element) {
...
goog.dom.browserrange.IeRange.insertNode_ = function(clone, node, before, opt_domHelper) {
  ...
  node = goog.dom.browserrange.IeRange.pasteElement_(clone, /** @type {!Element} */ (node), opt_domHelper);
  if (isNonElement) {
...
/** @override */ goog.dom.browserrange.IeRange.prototype.insertNode = function(node, before) {
  var output = goog.dom.browserrange.IeRange.insertNode_(this.range_.duplicate(), node, before);
  this.clearCachedValues_();
  return output;
};
/** @override */ goog.dom.browserrange.IeRange.prototype.surroundWithNodes = function(startNode, endNode) {
...
/** @override */ goog.dom.browserrange.IeRange.prototype.collapse = function(toStart) {
...
//# sourceMappingURL=goog.dom.browserrange.ierange.js.map
