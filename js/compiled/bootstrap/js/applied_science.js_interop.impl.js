...
return cljs.core.name(G__56672);
} else {
return G__56672;
}
});
...
var G__56694 = (i + (1));
var G__56695 = (obj__$1[cljs.core.nth.cljs$core$IFn$_invoke$arity$2(ks_STAR_,i)]);
i = G__56694;
obj__$1 = G__56695;
continue;
}
...
var temp__5722__auto__ = applied_science.js_interop.impl.get_value_by_keys(obj,cljs.core.butlast(ks_STAR_));
if((temp__5722__auto__ == null)){
return not_found;
} else {
