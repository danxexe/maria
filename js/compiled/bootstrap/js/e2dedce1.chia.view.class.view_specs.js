...
chia.view.class$.view_specs.Hiccup_QMARK_ = (function chia$view$class$view_specs$Hiccup_QMARK_(p1__49492_SHARP_){
return ((cljs.core.vector_QMARK_(p1__49492_SHARP_)) && ((cljs.core.first(p1__49492_SHARP_) instanceof cljs.core.Keyword)));
});
chia.view.class$.view_specs.SVG_QMARK_ = (function chia$view$class$view_specs$SVG_QMARK_(p1__49493_SHARP_){
return ((chia.view.class$.view_specs.Hiccup_QMARK_(p1__49493_SHARP_)) && (clojure.string.starts_with_QMARK_(cljs.core.name(cljs.core.first(p1__49493_SHARP_)),"svg")));
});
/**
...
var or__4131__auto__ = (function (){var fexpr__49496 = cljs.core.first(fns__$1);
return (fexpr__49496.cljs$core$IFn$_invoke$arity$1 ? fexpr__49496.cljs$core$IFn$_invoke$arity$1(this$) : fexpr__49496.call(null,this$));
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__49578 = cljs.core.rest(fns__$1);
fns__$1 = G__49578;
continue;
}
}
...
/** @this {Function} */
chia.view.class$.view_specs.any_pred.cljs$lang$applyTo = (function (seq49494){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq49494));
});
