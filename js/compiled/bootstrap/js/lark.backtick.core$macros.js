...
var temp__5718__auto__ = (function (){var fexpr__70790 = cljs.core.deref(lark.backtick.core$macros._STAR_gensyms_STAR_);
return (fexpr__70790.cljs$core$IFn$_invoke$arity$1 ? fexpr__70790.cljs$core$IFn$_invoke$arity$1(sym) : fexpr__70790.call(null,sym));
})();
...
return (function lark$backtick$core$macros$quote_fn_STAR__$_iter__70809(s__70810){
return (new cljs.core.LazySeq(null,((function (xs){
return (function (){
var s__70810__$1 = s__70810;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__70810__$1);
if(temp__5720__auto__){
var s__70810__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__70810__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__70810__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__70812 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__70811 = (0);
while(true){
if((i__70811 < size__4522__auto__)){
var x = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__70811);
cljs.core.chunk_append(b__70812,((lark.backtick.core$macros.unquote_splicing_QMARK_(x))?cljs.core.second(x):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(lark.backtick.core$macros.quote_fn_STAR_.cljs$core$IFn$_invoke$arity$1 ? lark.backtick.core$macros.quote_fn_STAR_.cljs$core$IFn$_invoke$arity$1(x) : lark.backtick.core$macros.quote_fn_STAR_.call(null,x))], null)));

var G__70848 = (i__70811 + (1));
i__70811 = G__70848;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__70812),lark$backtick$core$macros$quote_fn_STAR__$_iter__70809(cljs.core.chunk_rest(s__70810__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__70812),null);
}
} else {
var x = cljs.core.first(s__70810__$2);
return cljs.core.cons(((lark.backtick.core$macros.unquote_splicing_QMARK_(x))?cljs.core.second(x):new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(lark.backtick.core$macros.quote_fn_STAR_.cljs$core$IFn$_invoke$arity$1 ? lark.backtick.core$macros.quote_fn_STAR_.cljs$core$IFn$_invoke$arity$1(x) : lark.backtick.core$macros.quote_fn_STAR_.call(null,x))], null)),lark$backtick$core$macros$quote_fn_STAR__$_iter__70809(cljs.core.rest(s__70810__$2)));
}
} else {
return null;
}
...
var ret__4776__auto___70867 = lark.backtick.core$macros.template = (function lark$backtick$core$macros$template(_AMPERSAND_form,_AMPERSAND_env,form){
var _STAR_gensyms_STAR__orig_val__70824 = lark.backtick.core$macros._STAR_gensyms_STAR_;
var _STAR_gensyms_STAR__temp_val__70825 = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
lark.backtick.core$macros._STAR_gensyms_STAR_ = _STAR_gensyms_STAR__temp_val__70825;

try{return lark.backtick.core$macros.quote_fn_STAR_(form);
}finally {lark.backtick.core$macros._STAR_gensyms_STAR_ = _STAR_gensyms_STAR__orig_val__70824;
}});
lark.backtick.core$macros.template.cljs$lang$macro = true;


//# sourceMappingURL=lark.backtick.core$macros.js.map
