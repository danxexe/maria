...
var G__66361 = new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(this$);
var fexpr__66360 = cljs.core.deref(lark.editor.view_index);
return (fexpr__66360.cljs$core$IFn$_invoke$arity$1 ? fexpr__66360.cljs$core$IFn$_invoke$arity$1(G__66361) : fexpr__66360.call(null,G__66361));
});
...
if(((function (){var fexpr__66362 = cljs.core.deref(lark.editor.view_index);
return (fexpr__66362.cljs$core$IFn$_invoke$arity$1 ? fexpr__66362.cljs$core$IFn$_invoke$arity$1(id) : fexpr__66362.call(null,id));
})() == null)){
} else {
throw (new Error("Assert failed: (nil? ((clojure.core/deref view-index) id))"));
}
...
var G__66366 = lark.editor.view(block);
if((G__66366 == null)){
return null;
} else {
return G__66366.getEditor();
}
});
...
var G__66532 = lark.editor.get_cursor(editor);
if((G__66532 == null)){
return null;
} else {
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(G__66532,lark.editor.start(editor));
}
});
...
//# sourceMappingURL=lark.editor.js.map
