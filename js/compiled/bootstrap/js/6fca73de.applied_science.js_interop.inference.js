...
var G__52766 = cljs.core.name(tag);
var G__52767 = tag;
var fexpr__52765 = new cljs.core.PersistentArrayMap(null, 3, ["Array",new cljs.core.Symbol(null,"array","array",-440182315,null),"String",new cljs.core.Symbol(null,"string","string",-349010059,null),"Keyword",new cljs.core.Symbol(null,"keyword","keyword",-1843046022,null)], null);
return (fexpr__52765.cljs$core$IFn$_invoke$arity$2 ? fexpr__52765.cljs$core$IFn$_invoke$arity$2(G__52766,G__52767) : fexpr__52765.call(null,G__52766,G__52767));
} else {
return null;
}
}
...
var G__52775 = applied_science.js_interop.inference.infer_tags(env,form);
if((G__52775 == null)){
return null;
} else {
return applied_science.js_interop.inference.within_QMARK_(tags,G__52775);
}
} else {
return null;
}
