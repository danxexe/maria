...
var digit_58432 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_58433__$1 = (vlq >>> (5));
while(true){
if((vlq_58433__$1 > (0))){
var digit_58434__$1 = (digit_58432 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_58434__$1));

var G__58435 = (vlq_58433__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__58436 = (vlq_58433__$1 >>> (5));
digit_58432 = G__58435;
vlq_58433__$1 = G__58436;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_58432));
}
break;
}
...
var G__58443 = i__$1;
var G__58444 = result__$1;
var G__58445 = shift__$1;
i = G__58443;
result = G__58444;
shift = G__58445;
continue;
