...
var digit_42380 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_42381__$1 = (vlq >>> (5));
while(true){
if((vlq_42381__$1 > (0))){
var digit_42382__$1 = (digit_42380 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_42382__$1));

var G__42383 = (vlq_42381__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__42384 = (vlq_42381__$1 >>> (5));
digit_42380 = G__42383;
vlq_42381__$1 = G__42384;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_42380));
}
break;
}
...
var G__42390 = i__$1;
var G__42391 = result__$1;
var G__42392 = shift__$1;
i = G__42390;
result = G__42391;
shift = G__42392;
continue;
