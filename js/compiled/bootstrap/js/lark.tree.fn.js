...
var syms = (function (){var iter__4523__auto__ = (function lark$tree$fn$fn_walk_$_iter__63972(s__63973){
return (new cljs.core.LazySeq(null,(function (){
var s__63973__$1 = s__63973;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__63973__$1);
if(temp__5720__auto__){
var s__63973__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__63973__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__63973__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__63975 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__63974 = (0);
while(true){
if((i__63974 < size__4522__auto__)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__63974);
...
cljs.core.chunk_append(b__63975,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__64008 = (i__63974 + (1));
i__63974 = G__64008;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__63975),lark$tree$fn$fn_walk_$_iter__63972(cljs.core.chunk_rest(s__63973__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__63975),null);
}
} else {
var i = cljs.core.first(s__63973__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),lark$tree$fn$fn_walk_$_iter__63972(cljs.core.rest(s__63973__$2)));
}
} else {
return null;
}
...
return (function (p1__63971_SHARP_){
var or__4131__auto__ = lark.tree.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__63971_SHARP_);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
return p1__63971_SHARP_;
}
...
//# sourceMappingURL=lark.tree.fn.js.map
